			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="vigente" title="${message(code: 'tipoDocumento.vigente.label', default: 'Vigente')}" />
				...
				<g:each in="${tipoDocumentoInstanceList}" status="i" var="tipoDocumentoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${tipoDocumentoInstance.vigente}" /></td>
