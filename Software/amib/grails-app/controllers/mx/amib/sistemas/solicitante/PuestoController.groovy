...
class PuestoController {
    ...
    def show(Long id) {
        def puestoInstance = Puesto.get(id)
        if (!puestoInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'puesto.label', default: 'Puesto'), id])
    ...
    def delete(Long id) {
        ...
        try {
            ...
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'puesto.label', default: 'Puesto'), id])
