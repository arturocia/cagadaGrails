		...
		<div id="show-nivelEstudios" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${nivelEstudiosInstance?.id}" />
					<g:link class="edit" action="edit" id="${nivelEstudiosInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
