	...
	<body>
		...
		<div id="show-tipoDocumento" class="content scaffold-show" role="main">
			...
			<ol class="property-list tipoDocumento">
				...
				<g:if test="${tipoDocumentoInstance?.vigente}">
				<li class="fieldcontain">
					<span id="vigente-label" class="property-label"><g:message code="tipoDocumento.vigente.label" default="Vigente" /></span>
					
						<span class="property-value" aria-labelledby="vigente-label"><g:formatBoolean boolean="${tipoDocumentoInstance?.vigente}" /></span>
