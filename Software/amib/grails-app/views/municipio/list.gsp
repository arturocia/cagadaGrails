			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="municipio.entidadFederativa.label" default="Entidad Federativa" /></th>
					
						<g:sortableColumn property="vigente" title="${message(code: 'municipio.vigente.label', default: 'Vigente')}" />
				...
				<g:each in="${municipioInstanceList}" status="i" var="municipioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: municipioInstance, field: "entidadFederativa")}</td>
					
						<td><g:formatBoolean boolean="${municipioInstance.vigente}" /></td>
