	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.apellidop}">
				<li class="fieldcontain">
					<span id="apellidop-label" class="property-label"><g:message code="usuario.apellidop.label" default="Apellidop" /></span>
					
						<span class="property-value" aria-labelledby="apellidop-label"><g:fieldValue bean="${usuarioInstance}" field="apellidop"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${usuarioInstance?.apellidom}">
				<li class="fieldcontain">
					<span id="apellidom-label" class="property-label"><g:message code="usuario.apellidom.label" default="Apellidom" /></span>
					
						<span class="property-value" aria-labelledby="apellidom-label"><g:fieldValue bean="${usuarioInstance}" field="apellidom"/></span>
